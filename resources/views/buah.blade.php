        ...
        <div class="row">
             <div class="col-12 col-cm-12 col-md-6 col-lg-4">
                <div class="card" style="width: 18rem;">
                        <img src="https://cdn02.indozone.id/re/content/2019/05/23/n0sgBN/t_5ce672d26ce66.jpg?w=700&q=85" class="card-img-top" alt="#">
                    <div class="card-body">
                        <p class="card-title">Pentingnya Mengonsumsi Buah Setiap Hari
                        ...
                        Menjaga kesehatan mata dan mencegah penyakit mata terkait penuaan, katarak, dan degenerasi makula.</p>
                    </div>
                 </div>
            </div>
        </div>
